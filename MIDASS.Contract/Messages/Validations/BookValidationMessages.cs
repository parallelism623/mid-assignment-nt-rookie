...
public static class BookValidationMessages
{
    ...
    public const string TitleShouldLessEqualThanMaxLength = "Book title should less equal than max length";
    public const string DescriptionShouldLessEqualThanMaxLength = "Book description should less equal than max length";
    public const string AuthorShouldLessEqualThanMaxLength = "Book author should less equal than max length";
